...
export namespace TodoActions {
  ...
  export const addTodo = createAction<Partial<TodoModel>&Pick<TodoModel,'text'&'amount'>>(Type.ADD_TODO);
  export const editTodo = createAction<Partial<TodoModel>&Pick<TodoModel,'text'&'amount'>>(Type.EDIT_TODO);
